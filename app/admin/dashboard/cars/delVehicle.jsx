...
export const DelVehicle = ({ vehicleId, setDelVehicle, setFetchData,setViewVehicle }) => {
    ...
    useEffect(() => {
        ...
        const del = async () => {
            ...
            try {
                ...
                const docRef = doc(db, `raloc/logistics/vehicles/${vehicleId}`);
        ...
        <div className="fixed top-0 left-0 w-full h-svh bg-white/30 backdrop-blur-[1px] flex items-center justify-center">
            <div className="shadow-md bg-black text-white rounded-md max-w-xl w-full mx-auto p-6 border border-red-600">
                ...
                <div className="flex justify-between mt-5">
                    ...
                    <button onClick={() => setDelVehicle(false)} type="button" className="border border-red-600 hover:bg-red-600 transition duration-500 p-2 rounded-md hover:text-white">
                        No
                    </button>
                </div>
            </div>
